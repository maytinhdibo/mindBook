package com.mtc.mindbook.models.foryou;
...
public class RecyclerForYouViewAdapter extends RecyclerView.Adapter<RecyclerForYouViewAdapter.RecyclerViewHolder>{

    private List<SearchItem> data = new ArrayList<>();

    public RecyclerForYouViewAdapter(List<SearchItem> data) {
        this.data = data;
    }
